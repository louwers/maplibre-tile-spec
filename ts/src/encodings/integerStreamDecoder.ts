...
export default class IntegerStreamDecoder {
    ...
    static decodeLengthStreamToOffsetBuffer(
        data: Uint8Array,
        offset: IntWrapper,
        streamMetadata: StreamMetadata,
    ): Int32Array {
    ...
    static decodeSequenceIntStream(
        data: Uint8Array,
        offset: IntWrapper,
        streamMetadata: StreamMetadata,
    ...
    static decodeSequenceLongStream(
        data: Uint8Array,
        offset: IntWrapper,
        streamMetadata: StreamMetadata,
    ...
    static decodeLongFloat64Stream(
        data: Uint8Array,
        offset: IntWrapper,
        streamMetadata: StreamMetadata,
        isSigned: boolean,
    ...
    private static decodeIntBuffer(
        values: Int32Array,
        streamMetadata: StreamMetadata,
        isSigned: boolean,
        scalingData?: GeometryScaling,
    ...
    private static decodeLongBuffer(
    ...
    private static decodeFloat64Buffer(
        values: Float64Array,
        streamMetadata: StreamMetadata,
        isSigned: boolean,
    ): Float64Array {
    ...
    public static decodeNullableLongStream(
        data: Uint8Array,
        offset: IntWrapper,
        streamMetadata: StreamMetadata,
        isSigned: boolean,
